...
user in an INI file next to FileZillaPortable.exe called FileZillaPortable.ini.
...
copy AppNamePortable.ini from this directory to FileZillaPortable.ini next to
FileZillaPortable.exe. The options in the INI file are as follows:
